...
public class MTEIsofluxWireMatrix extends GTPPMultiBlockBase<MTEIsofluxWireMatrix>
    implements ISurvivalConstructable {

    private int mCasing;
    private static IStructureDefinition<MTEIsofluxWireMatrix> STRUCTURE_DEFINITION = null;

    public MTEIsofluxWireMatrix(final int aID, final String aName, final String aNameRegional) {
        super(aID, aName, aNameRegional);
    }

    public MTEIsofluxWireMatrix(final String aName) {
        super(aName);
    }

    @Override
    public IMetaTileEntity newMetaEntity(final IGregTechTileEntity aTileEntity) {
        return new MTEIsofluxWireMatrix(this.mName);
    }

    @Override
    public String getMachineType() {
        return "Wiremill, Isoflux Wire Matrix";
    }
    ...
    protected MultiblockTooltipBuilder createTooltip() {
        ...
        tt.addMachineType(getMachineType())
            ...
            .addCasingInfoMin("Isoflux Casings", 14, false)
    ...
    @Override
    public IStructureDefinition<MTEIsofluxWireMatrix> getStructureDefinition() {
        if (STRUCTURE_DEFINITION == null) {
            STRUCTURE_DEFINITION = StructureDefinition.<MTEIsofluxWireMatrix>builder()
                .addShape(
                    mName,
                ...
                .addElement(
                    'C',
                    buildHatchAdder(MTEIsofluxWireMatrix.class)
    ...
    protected IIconContainer getActiveOverlay() {
        return TexturesGtBlock.oMCDIndustrialWireMillActive; // TODO swap to Isoflux textures later
    }
